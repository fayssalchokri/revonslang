...
#[revonslang(vm_type = "std.http.types.Body")]
#[revonslang(crate_name = "::vm")]
...
// Since `Body` implements `Userdata` revonslang will automatically marshal the revonslang representation
// into `&Body` argument
